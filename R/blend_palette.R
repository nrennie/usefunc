...
#' @param palette The starting vector for the palette, which must be either be
#' recognised colour names (e.g. "blue") or hex colour codes (e.g. "#ffffff").
#' @param blend_colour The colour to blend with, which must be either be a
#' recognised colour name (e.g. "blue") or a hex colour code (e.g. "#ffffff").
